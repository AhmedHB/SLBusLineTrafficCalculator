...
public class SlTrafficCalculatorApplication {
    ...
    public Docket apiDocumentation() {
        ...
        return new Docket(SWAGGER_2)
                .select()
                .apis(basePackage("com.ahmed.sltrafficcalculator"))
    ...
    public static void main(String[] args) {
        SpringApplication.run(SlTrafficCalculatorApplication.class, args);
    }
